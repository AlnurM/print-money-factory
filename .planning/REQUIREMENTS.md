...
- [x] **ARCH-04**: Reference backtest engine patterns for Claude to adapt per strategy
- [x] **ARCH-05**: Template files: STRATEGY.md, STATE.md, pinescript-template.pine, report-template.html
