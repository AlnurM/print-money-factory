...
Plans:
- [ ] 01-01-PLAN.md -- npm package scaffolding + install script (commands, package.json, bin/install.mjs, requirements.txt)
...
|-------|----------------|--------|-----------|
| 1. Package Scaffolding & Install | 0/4 | Planning complete | - |
